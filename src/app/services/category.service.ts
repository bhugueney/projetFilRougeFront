...
export class CategoryService {
  ...
  /**
   * This method return list of categories without category child
   * @returns {Observable<Categorie[]>}
   */
  public getLeafCategories(): Observable<Categorie[]> {
    return this.http.get<Categorie[]>(this.URL_CATEGORIE + '/?type=LEAF');
  }
